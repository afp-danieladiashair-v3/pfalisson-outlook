    ...
    },
    {
      icon: (
        <svg
          ...
          className="w-5 h-5"
        >
          <rect width="432" height="432" x="8" y="8" fill="#FF0000" rx="120.961" />
          <path
            fill="#FFFFFF"
            d="M176.5,100.3c-2.6,-9.6 -10.2,-17.3 -19.8,-20.5c-17.9,-4.5 -90.2,-4.5 -90.2,-4.5c0,0 -72.3,0 -90.2,4.5c-9.6,3.2 -17.3,10.9 -19.8,20.5c-5.1,17.9 -5.1,55.7 -5.1,55.7c0,0 0,37.1 5.1,55.7c2.5,9.6 10.2,17.3 19.8,19.8c17.9,5.1 90.2,5.1 90.2,5.1c0,0 72.3,0 90.2,-5.1c9.6,-2.5 17.3,-10.2 19.8,-19.8c5.1,-18.6 5.1,-55.7 5.1,-55.7c0,0 0,-37.8 -5.1,-55.7Zm-133.1,90.2c0,-69.1 0,-69.1 0,-69.1l60.2,34.6l-60.2,34.5Z"
          />
        </svg>
      ),
